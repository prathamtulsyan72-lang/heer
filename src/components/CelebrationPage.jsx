  ...
  return (
    ...
    <div className={`celebration-page ${lightsOn ? "lights-on" : ""}`}>
      ...
      <h1 className="main-title">
        Happy Birthday <span>Heer</span> 🎂
      </h1>

      <p className="subtitle">
        To the most special girl ever, may your day be filled with smiles and love ❤️
      </p>
    </div>
      ...
      <div className="floating-hearts-bg">
        {heartPositions.map((pos, i) => (
          ...
          >
           May this small wish makes your whole birthday feel very special 💗
          </div>
        ))}
      </div>
