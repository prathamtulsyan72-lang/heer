      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Heer</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Heer's</span>{"special day "}
                special day 🎂
              </>
            )}
          </h1>
          <p> Happiest birthday heer may your birthday be fillled with lots of love laughter and happiness 💗</p>
        </section>
...
<MessageCard isActive={currentPage === 3} />
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — [Pratham] 💖</h2>
          <p className="final-subtitle">I hope you liked a small gift but with a great load of love ✨</p>
        </section>
      </div>
